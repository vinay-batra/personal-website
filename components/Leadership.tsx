...
const ENTRIES: Entry[] = [
  {
    ...
    org: "INDEPENDENT · BENCHMARKED VS S&P 500",
    desc: "Started managing my own capital. Moved from stock-picking to structured, long-term allocation. It's the discipline everything else here is built on.",
  },
  {
    year: "2025",
    role: "AI & Finance Program",
    org: "BETTERMIND LABS",
    desc: "Built a stock forecasting application with TensorFlow and Prophet, from data cleaning through deployment.",
  },
  {
    year: "2025",
    role: "Founder",
    org: "CORVO · CORVO.CAPITAL",
    desc: "Portfolio intelligence platform: Monte Carlo simulation, VaR, correlation, an AI analyst. Launched on Product Hunt.",
  },
  {
    year: "2025",
    role: "Director of Technology",
    org: "FUTURE JAIN LEADERSHIP PROGRAM (JITO YOUTH)",
    desc: "Own everything digital for a national 501(c)(6) leadership nonprofit operating across five regions.",
  },
  {
    year: "2026",
    role: "Chief Science Officer",
    org: "COUNCIL ROCK HS SOUTH",
    desc: "Leading the development of a student-led STEM innovation competition.",
  },
  {
    year: "2026",
    role: "President",
    org: "ENVIRONMENTAL ACTION CLUB",
    desc: "Organized a 200+ participant community e-waste drive; Earth Week education in elementary schools.",
  },
  {
    year: "2026",
...
export default function Leadership() {
  ...
  // Drives the big mono year readout — entry years span 2021 → 2026.
  const { scrollYProgress: yearProgress } = useScroll({
    target: sectionRef,
    offset: ["start center", "end center"],
  });
  useMotionValueEvent(yearProgress, "change", (v) => {
    setYear(Math.round(YEAR_MIN + v * (YEAR_MAX - YEAR_MIN)));
  });
